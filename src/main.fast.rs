...
const SYNERGIES: usize = SPELLWEAVER + 1;

const SYNERGY_NAMES: [&str; SYNERGIES] = [
    "abomination",
    "coven",
    "dawnbringer",
    "draconic",
...
const CHAMPS: [&[usize]; NUM_CHAMPS] = [
    &[REDEEMED, LEGIONNAIRE],               // Aatrox
    &[NIGHTBRINGER, RANGER],                // Aphelios
    &[VERDANT, DRACONIC, RANGER],           // Ashe
    &[ABOMINATION, SPELLWEAVER],            // Brand
    &[NIGHTBRINGER, DRAGONSLAYER, ASSASSIN],// Diana
    &[FORGOTTEN, LEGIONNAIRE],              // Draven
    &[DAWNBRINGER, BRAWLER],                // Gragas
    &[FORGOTTEN, CAVALIER],                 // Hecarim
    &[REVENANT, INVOKER, RENEWER],          // Ivern
    &[IRONCLAD, SKIRMISHER],                // Jax
    &[ABOMINATION, LEGIONNAIRE],            // Kalista
    &[DAWNBRINGER, INVOKER],                // Karma
    &[FORGOTTEN, ASSASSIN],                 // Katarina
    &[HELLION, SKIRMISHER],                 // Kennen
    &[DAWNBRINGER, ASSASSIN],               // Khazix
    &[HELLION, CAVALIER],                   // Kled
    &[COVEN, ASSASSIN],                     // Leblanc
    &[NIGHTBRINGER, SKIRMISHER],            // LeeSin
    &[REDEEMED, KNIGHT],                    // Leona
    &[COVEN, RENEWER],                      // Lissandra
    &[HELLION, MYSTIC],                     // Lulu
    &[REDEEMED, MYSTIC],                    // Lux
    &[DRAGONSLAYER, LEGIONNAIRE],           // Mordekaiser
    &[COVEN, NIGHTBRINGER, MYSTIC],         // Morgana
    &[IRONCLAD, KNIGHT],                    // Nautilus
    &[DAWNBRINGER, SKIRMISHER],             // Nidalee
    &[REVENANT, ASSASSIN],                  // Nocturne
    &[ABOMINATION, BRAWLER],                // Nunu
    &[DRAGONSLAYER, SKIRMISHER],            // Pantheon
    &[HELLION, KNIGHT],                     // Poppy
    &[REDEEMED, IRONCLAD, CAVALIER],        // Rell
    &[DAWNBRINGER, LEGIONNAIRE],            // Riven
    &[ABOMINATION, FORGOTTEN, MYSTIC],      // Ryze
    &[NIGHTBRINGER, CAVALIER],              // Sejuani
    &[DRACONIC, BRAWLER],                   // Sett
    &[DAWNBRINGER, RENEWER],                // Soraka
    &[REDEEMED, INVOKER],                   // Syndra
    &[VERDANT, KNIGHT],                     // Taric
    &[FORGOTTEN, KNIGHT],                   // Thresh
    &[DRAGONSLAYER, SKIRMISHER],            // Trundle
    &[DRACONIC, SKIRMISHER],                // Udyr
    &[REDEEMED, RANGER],                    // Varus
    &[FORGOTTEN, RANGER],                   // Vayne
    &[REDEEMED, SPELLWEAVER],               // Velkoz
    &[FORGOTTEN, SPELLWEAVER],              // Viktor
    &[NIGHTBRINGER, RENEWER],               // Vladmir
    &[FORGOTTEN, BRAWLER],                  // Warwick
    &[NIGHTBRINGER, LEGIONNAIRE],           // Yasuo
    &[HELLION, SPELLWEAVER],                // Ziggs
    &[DRACONIC, SPELLWEAVER],               // Zyra
